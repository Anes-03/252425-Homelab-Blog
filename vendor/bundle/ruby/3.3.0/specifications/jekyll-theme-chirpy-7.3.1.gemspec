# -*- encoding: utf-8 -*-
# stub: jekyll-theme-chirpy 7.3.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<jekyll>.freeze, ["~> 4.3".freeze])
  s.add_runtime_dependency(%q<jekyll-paginate>.freeze, ["~> 1.1".freeze])
  s.add_runtime_dependency(%q<jekyll-seo-tag>.freeze, ["~> 2.8".freeze])
  s.add_runtime_dependency(%q<jekyll-archives>.freeze, ["~> 2.2".freeze])
